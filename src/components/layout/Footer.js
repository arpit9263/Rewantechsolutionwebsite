...
function LogoMark() {
  return (
    <Link
      ...
      aria-label="Rewan Tech Solutions Home"
    >
      <Image
        src="/logo.svg"
        alt="Rewan Tech Solutions logo"
        width={170}
        height={52}
        priority={false}
        style={{
    ...
    <footer style={{ background: 'var(--bg2)', borderTop: '1px solid var(--bdr)', position: 'relative', overflow: 'hidden' }}>
      ...
      <div
        style={{
          ...
          padding: 'clamp(44px,7vw,80px) clamp(20px,5vw,80px)',
          position: 'relative',
          zIndex: 1,
        }}
      >
        <div
          style={{
            ...
            pointerEvents: 'none',
            animation: 'glow-p 7s ease-in-out infinite',
          }}
        />
        <div
          className="ctr footer-cta-row"
          style={{
            display: 'flex',
      ...
      <div
        style={{
          padding: 'clamp(44px,6vw,72px) clamp(20px,5vw,80px) clamp(28px,4vw,40px)',
          position: 'relative',
          zIndex: 1,
        }}
      >
          ...
          >
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                {[
                  ...
                  >
                    <span style={{ color: 'var(--t3)', flexShrink: 0 }}>{c.icon}</span>
                    {c.v}
                  </a>
                ))}
              </div>
            ...
            <div>
              ...
              <a
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = 'rgba(221,42,123,0.14)';
                  e.currentTarget.style.borderColor = 'rgba(221,42,123,0.3)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = 'rgba(221,42,123,0.07)';
                  e.currentTarget.style.borderColor = 'rgba(221,42,123,0.15)';
                }}
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                  <rect x="2" y="2" width="20" height="20" rx="5" stroke="#dd2a7b" strokeWidth="2" />
                  <circle cx="12" cy="12" r="4" stroke="#dd2a7b" strokeWidth="2" />
              ...
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--bl)" strokeWidth="1.5">
                  <rect x="3" y="4" width="18" height="18" rx="2" />
                  <line x1="16" y1="2" x2="16" y2="6" />
                  <line x1="8" y1="2" x2="8" y2="6" />
                  <line x1="3" y1="10" x2="21" y2="10" />
